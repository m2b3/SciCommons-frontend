...
export const markdownStyles =
  'prose prose-sm dark:prose-invert max-w-none text-text-primary [&_h1]:text-2xl [&_h2]:text-xl [&_h3]:text-lg [&_h4]:text-base [&_h5]:text-sm [&_h6]:text-xs [&_h1]:font-bold [&_h2]:font-bold [&_h3]:font-bold [&_h4]:font-bold [&_h5]:font-bold [&_h6]:font-bold [&_h1]:mb-4 [&_h2]:mb-3 [&_h3]:mb-2 [&_h4]:mb-2 [&_h5]:mb-1 [&_h6]:mb-1 [&_hr]:border-common-contrast [&_hr]:my-4 [&_blockquote]:border-l-4 [&_blockquote]:border-common-contrast [&_blockquote]:pl-4 [&_blockquote]:py-2 [&_blockquote]:bg-common-minimal [&_blockquote]:italic [&_p]:my-2 [&_a]:text-functional-blue [&_a]:underline [&_a]:hover:text-functional-blueLight [&_strong]:font-bold [&_strong]:text-text-primary [&_em]:italic [&_em]:text-text-primary [&_code]:bg-common-minimal [&_code]:px-1 [&_code]:py-0.5 [&_code]:rounded [&_code]:text-sm [&_code]:font-mono [&_pre]:bg-common-minimal [&_pre]:p-4 [&_pre]:rounded-lg [&_pre]:overflow-x-auto [&_pre_code]:bg-transparent [&_pre_code]:p-0 [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:my-2 [&_ol]:list-decimal [&_ol]:pl-6 [&_ol]:my-2 [&_li]:my-1 [&_table]:w-full [&_table]:border-collapse [&_table]:my-4 [&_th]:border [&_th]:border-common-contrast [&_th]:px-4 [&_th]:py-2 [&_th]:bg-common-minimal [&_th]:text-left [&_th]:font-bold [&_td]:border [&_td]:border-common-contrast [&_td]:px-4 [&_td]:py-2 [&_img]:rounded-lg [&_img]:my-4 [&_del]:line-through [&_del]:text-text-tertiary [&_mark]:bg-functional-yellowLight [&_mark]:text-text-primary [&_mark]:px-1 [&_mark]:rounded [&_details]:bg-common-minimal [&_details]:p-4 [&_details]:rounded-lg [&_details]:my-4 [&_summary]:font-bold [&_summary]:cursor-pointer [&_details[open]_summary]:mb-2 [&_.admonition]:rounded-lg [&_.admonition]:border-2 [&_.admonition]:p-4 [&_.admonition]:my-4 [&_.admonition-title]:font-bold [&_.admonition-title]:mb-2 [&_.admonition-note]:bg-functional-blueLight [&_.admonition-note]:border-functional-blue [&_.admonition-note]:text-text-primary [&_.admonition-tip]:bg-functional-greenLight [&_.admonition-tip]:border-functional-green [&_.admonition-tip]:text-text-primary [&_.admonition-info]:bg-functional-blueLight [&_.admonition-info]:border-functional-blue [&_.admonition-info]:text-text-primary [&_.admonition-caution]:bg-functional-yellowLight [&_.admonition-caution]:border-functional-yellow [&_.admonition-caution]:text-text-primary [&_.admonition-danger]:bg-functional-redLight [&_.admonition-danger]:border-functional-red [&_.admonition-danger]:text-text-primary';
