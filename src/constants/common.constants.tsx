...
/* Fixed by Codex on 2026-02-09
   Problem: Article title minimum length differed between create (5) and edit (10)
   Solution: Centralize the minimum length in a shared constant
   Result: Consistent validation rules across create/edit flows */
