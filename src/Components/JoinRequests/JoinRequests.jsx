                      ...
                      <h2 className="mb-0" id="headingOne">
                        ...
                        >
                          {request.profile_pic_url.includes("None") ? (
                            ...
                            <img
                              className="object-cover w-4 h-4 md:w-6 md:h-6 rounded-full mr-1 md:mr-3 ring ring-gray-300"
                          ...
                          <div className="flex flex-row items-center">
                            <div className="flex flex-col items-center mr-6">
                              {request.profile_pic_url.includes("None") ? (
                                ...
                                <img
                                  className="object-cover w-8 h-8 md:w-14 md:h-14 rounded-full mr-3 ring ring-gray-300"
                                  src={request.profile_pic_url}
                                  alt="avatar"
                                />
                              )}
        ...
        <div className="w-full h-full fixed block top-0 left-0 bg-gray-900 bg-opacity-50 z-50">
          <div className="w-full h-full flex flex-col items-center justify-center">
            <div className="w-5/6 md:w-1/2 bg-white p-5 rounded-lg flex flex-col items-center justify-center">
              <h1 className="text-md md:text-2xl font-bold text-gray-600 mb-4">
                Are you sure you want to add this member to the community?
              </h1>
