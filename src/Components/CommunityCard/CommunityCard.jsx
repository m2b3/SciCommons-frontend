    ...
    <>
      ...
      {community !== null && (
        <div
          ...
          onClick={() => {
            navigate(`/community/${community.Community_name}`);
          }}
        >
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-xl text-green-600 font-bold mb-4">
                {community.Community_name.replace(/_/g, " ")}
              </h2>
            </div>
          ...
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex">
              ...
              <span className="text-md text-left text-gray-500">{community?.subscribed}</span>
            </div>
          </div>
        </div>
      )}
