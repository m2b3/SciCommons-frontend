...
const ProfileHeader: React.FC<ProfileHeaderProps> = ({ name, image, bio, location, website }) => (
  <div className="mb-8 flex flex-col items-center space-y-4 rounded-lg bg-white p-6 shadow-md dark:bg-gray-800 sm:flex-row sm:items-start sm:space-x-6 sm:space-y-0">
    ...
    <div className="text-center sm:text-left">
      ...
      <p className="mt-2 max-w-2xl text-gray-600 dark:text-gray-300">{bio}</p>
...
export const ProfileHeaderSkeleton: React.FC = () => (
  <div className="mb-8 flex animate-pulse flex-col items-center space-y-4 rounded-lg bg-white p-6 shadow-md dark:bg-gray-800 sm:flex-row sm:items-start sm:space-x-6 sm:space-y-0">
    <div className="flex-shrink-0">
    ...
    <div className="text-center sm:text-left">
      ...
      <div className="mt-2 h-4 w-64 rounded bg-gray-300 dark:bg-gray-700"></div>
