  ...
  return (
    <>
      {/* Fixed by Codex on 2026-02-15
          Who: Codex
          What: Replace legal page hard-coded colors with semantic tokens.
          Why: Allow skins to restyle legal content without changing markup.
          How: Swap gray/green utilities for theme token classes. */}
      <div className="container mx-auto min-h-screen bg-common-background px-4 py-8">
        <h1 className="mb-8 text-center text-4xl font-bold text-text-primary">Privacy Policy</h1>
        ...
        <Card className="mb-8 transition-shadow hover:shadow-lg">
          ...
          <CardContent className="mt-4">
            <p className="mb-4">
              ...
              outside of our organization except in the following cases: with your consent, for
              legal reasons, or to protect rights, property, or safety.
            </p>
          </CardContent>
        </Card>
