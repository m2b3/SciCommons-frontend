  ...
  return (
    <>
      {/* Fixed by Codex on 2026-02-15
          ...
          How: Swap gray/blue utilities for theme token classes. */}
      <div className="container mx-auto min-h-screen bg-common-background px-4 py-8">
        ...
        <Card className="mb-8 transition-shadow hover:shadow-lg">
          ...
          <CardContent className="mt-4">
            <p className="mb-4">
              By accessing and using this open science publishing platform, you accept and agree to
        ...
        <Card className="mb-8 transition-shadow hover:shadow-lg">
          ...
          <CardContent className="mt-4">
            <p className="mb-4">
              ...
              password. Users are also responsible for all activities that occur under their
              account.
            </p>
          </CardContent>
        </Card>
