    ...
    return (
        <div>
            ...
            <div className="flex flex-col justify-center md:flex-row md:items-center">
                ...
                <form onSubmit={(e)=>handleSubmit(e)} className="flex flex-col justify-start" encType="multipart/form-data">
                <div className="flex flex-col justify-start">
                    ...
                    <div className="flex flex-row mt-3">
                        ...
                        <input style={{"border": "2px solid #cbd5e0"}} className={`border-2 border-gray-400 rounded-md w-4/5 ${edit?"bg-white":"bg-gray-200"} h-7 px-2`} name="first_name" type="text" value={first_name} onChange={(e)=>{setFirstName(e.target.value)}} disabled/>
                    </div>
                    <div className="flex flex-row mt-3">
                        <label className="text-lg font-bold mr-2 text-green-500" htmlFor="last_name">LastName</label>
                        <input style={{"border": "2px solid #cbd5e0"}} className={`border-2 border-gray-400 ${edit?"bg-white":"bg-gray-200"} rounded-md w-4/5 h-7 px-2`} name="last_name" type="text" value={last_name} onChange={(e)=>{setLastName(e.target.value)}} disabled/>
                    </div>
                    <div className="flex flex-row mt-3">
                        <label className="text-lg font-bold mr-2 text-green-500" htmlFor="institute">Institute</label>
                        <input style={{"border": "2px solid #cbd5e0"}} className={`border-2 border-gray-400 rounded-md ${edit?"bg-white":"bg-gray-200"} w-4/5 h-7 px-2`} name="institute" type="text" value={institute} onChange={(e)=>{setInstitute(e.target.value)}} disabled/>
                    </div>
                    <div className="flex flex-row mt-3">
                        <label className="text-lg font-bold mr-2 text-green-500" htmlFor="google_scholar">GoogleScholar</label>
                        <input style={{"border": "2px solid #cbd5e0"}} className={`border-2 border-gray-400 rounded-md ${edit?"bg-white":"bg-gray-200"} w-4/5 h-7 px-2`} name="google_scholar" type="text" value={google_scholar} onChange={(e)=>{setGoogleScholar(e.target.value)}} disabled/>
                    </div>
                    <div className="flex flex-row mt-3">
                        <label className="text-lg font-bold mr-2 text-green-500" htmlFor="pubmed">Pubmed</label>
                        <input style={{"border": "2px solid #cbd5e0"}} className={`border-2 border-gray-400 rounded-md ${edit?"bg-white":"bg-gray-200"} w-4/5 h-7 px-2`} name="pubmed" type="text" value={pubmed} onChange={(e)=>{setPubmed(e.target.value)}} disabled/>
                    </div>
