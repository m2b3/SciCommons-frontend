  ...
  const handleFollow = async (e, index) => {
    ...
    if (!followers[index].isFollowing) {
      try {
        ...
        updatedFollowers[index].isFollowing =
          !updatedFollowers[index].isFollowing;
                    ...
                    followers.map((follower, index) => (
                      ...
                      >
                        {follower.avatar.includes("None") ? (
                          <SlUser className="w-6 h-6 md:w-10 md:h-10 text-black-800 mr-4" />
                        ) : (
                          <img
                            src={follower.avatar}
          ...
          <div className="flex items-center mt-8 flex-col">
            ...
            <div>
              <div className="flex flex-row items-center justify-center">
                <h2 className="text-xl text-green-500 font-bold mt-3 text-center">
                  {User.username}
                </h2>
              </div>
