...
const buttonVariants = cva(
  /* Fixed by Codex on 2026-02-15
     Who: Codex
     What: Replace hard-coded button text colors with theme tokens.
     Why: Allow UI skins to control foreground contrast across variants.
     How: Use semantic token classes for base and variant text colors. */
  'inline-flex items-center justify-center whitespace-nowrap gap-2 select-none text-primary-foreground transition-all duration-100 ease-in-out rounded-md w-fit px-3 py-2 h-fit',
  {
    variants: {
      variant: {
        ...
        gray: 'bg-functional-gray hover:bg-functional-grayContrast text-text-primary',
        transparent: 'bg-transparent hover:bg-transparent text-text-primary',
        outline:
          'bg-transparent border border-common-minimal text-text-primary hover:bg-common-minimal/20',
        inverted: 'bg-common-cardBackground text-text-primary',
      },
      size: {
        default: 'text-base',
        sm: 'h-8 px-3 text-xs',
