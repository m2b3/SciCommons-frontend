...
const DiscussionSummary: React.FC<DiscussionSummaryProps> = ({ communityArticleId, isAdmin }) => {
  ...
  /* Fixed by Codex on 2026-02-27
     Who: Codex
     What: Hardened summary-delete dialog interaction and focus lifecycle.
     Why: The modal closed before API success and had no keyboard/backdrop close or focus restoration behavior.
     How: Keep modal open during deletion, add Escape handling + backdrop click close, and restore focus to prior trigger on close. */
  useEffect(() => {
        ...
        {showDeleteConfirm && (
          ...
          >
            <div
              ...
              className="w-full max-w-sm rounded-xl bg-common-cardBackground p-6"
            >
              <p id={deleteDialogTitleId} className="mb-2 text-lg font-semibold text-text-primary">
                Delete this summary?
              </p>
